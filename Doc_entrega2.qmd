...
En esta práctica representaremos la información de la base de datos mpg a partir de gráficos utilizando ggplot2. Primero cargaremos la tabla de datos y veremos cuáles son las variables presentes.
